...
function print_listing_li($item_id, $title, $desc, $price, $num_bids,$start_time, $end_time, $buy_now_price, $is_admin=False, $auction_id=null)
{
  ...
  if ($is_admin){
    $admin_button = '<div class="mt-2">
      <form method="POST" action="' . BASE_URL . '/actions/delete_listing.php" onsubmit="return confirm(\'Are you sure you want to disable this listing?\');"> 
    ...
    <div class="p-2 mr-5"><h5><a href="' . BASE_URL . '/listing.php?item_id=' . $item_id . '">' . $title . '</a></h5>' . $desc_shortened . '</div>
  ...
  <table class="table table-striped table-hover mt-3">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <form method="POST" action="<?php echo BASE_URL; ?>/actions/enable_acc.php" onsubmit="return confirm('Are you sure you want to <?php echo $action; ?> this account?');"> 
...
function print_bid_li($item_id, $title, $description, $bid_amount, $bid_date) {
    ...
    <li class="list-group-item d-flex justify-content-between">
        <div class="p-2 mr-5">
            <h5><a href="' . BASE_URL . '/listing.php?item_id=' . $item_id . '">' . htmlspecialchars($title) . '</a></h5>

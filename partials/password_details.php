<?php
// Parent page handles headers/utilities.
...
<form action="<?php echo BASE_URL; ?>/actions/process_change_password.php" method="POST" class="form-horizontal">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="password" class="form-control" id="newpassword1" placeholder="New Password" name="newpassword1" required minlength="6">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="password" class="form-control" id="newpassword2" placeholder="Re-enter New Password" name="newpassword2" required minlength="6">
        </div>
    </div>

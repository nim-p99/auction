...
// 1. Check for Flash Messages from process_address.php
if (isset($_SESSION['address_msg'])) {
    $msg = $_SESSION['address_msg'];
    $type = $_SESSION['address_type'] ?? 'info';
...
<form action="<?php echo BASE_URL; ?>/actions/process_address.php" method="POST" class="form-horizontal">

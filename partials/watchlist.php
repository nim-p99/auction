...
if (!$user_id) {
    echo "<div class='alert alert-info'>Please log in to view your watchlist.</div>";
    return;
}
...
$qs_prefix = ($current_page_url == 'buyer.php') ? 'tab=watchlist&' : 'section=buyer&tab=watchlist&';

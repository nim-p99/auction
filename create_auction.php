...
// --- DB connection (using your config file) ---
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <small id="titleHelp" class="form-text text-muted">
              ...
              A short description of the item you're selling, which will display in listings.
            </small>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <small id="detailsHelp" class="form-text text-muted">
              Full details of the listing to help bidders decide if it's what they're looking for.
            </small>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
	        <div class="input-group">
              ...
              <input type="number" class="form-control" id="auctionStartPrice" name="auctionStartPrice" step="0.01">
            </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              ...
              <input type="number" class="form-control" id="auctionReservePrice" name="auctionReservePrice" step="0.01">
            </div>
